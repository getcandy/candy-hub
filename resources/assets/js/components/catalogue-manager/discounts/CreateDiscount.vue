<script>
    ...
    export default {
        ...
        methods: {
            addSet() {
                this.discount.sets.push({
                    items: []
                })
            },
            addCustomerGroup(set) {
                this.discount.sets[set].items.push({
                    target: 'Customer',
                    operator: 'IN',
            ...
            removeSet(index) {
                this.discount.sets.splice(index, 1);
            },
            removeCriteria(set, index) {
                this.discount.sets[set].items.splice(index, 1);
            }
        },
        components: {
            flatPickr
