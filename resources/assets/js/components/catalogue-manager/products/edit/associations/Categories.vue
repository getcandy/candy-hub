      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td align="right"><button class="btn btn-sm btn-default btn-action" data-toggle="modal" data-target="#removeCategory"><i class="fa fa-trash-o" aria-hidden="true"></i></button></td>
          </tr>
          <tr>
            <td width="80"><img src="/images/placeholder/product.jpg" alt="Aquacomb"></td>
            <td>Category</td>
