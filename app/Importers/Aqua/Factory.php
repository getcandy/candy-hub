...
class Factory extends BaseImporter
{
    ...
    {
        $products = Product::with(['images', 'channel', 'inventory', 'inventory.image', 'categories', 'redirects', 'options', 'options.description', 'options.variants', 'options.variants.description'])->get();
