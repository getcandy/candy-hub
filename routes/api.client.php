...
$this->delete('baskets/{id}/discounts', 'Baskets\BasketController@deleteDiscount');
$this->put('baskets/{id}/user', 'Baskets\BasketController@putUser');
$this->delete('baskets/{id}/user', 'Baskets\BasketController@deleteUser');
