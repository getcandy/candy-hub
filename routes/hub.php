...
Route::group([
    ...
    'middleware' => ['web', 'hub.refresh_token', 'hub.access'],
], function ($router) {
    ...
    //  * Hub Routes
    //  */
    // $router->group(['middleware' => ['hub', 'auth']], function ($router) {
    ...
    //      */
    //     $router->group(['prefix' => 'catalogue-manager', 'namespace' => 'Cms\\CatalogueManager'], function ($router) {
    //         $router->get('products', [
    ...
    //     $router->group(['prefix' => 'order-processing', 'namespace' => 'Cms\\OrderProcessing'], function ($router) {
    //         $router->get('orders', [
    //             'as' => 'hub.orders.index',
    ...
    //     $router->group(['prefix' => 'marketing-suite', 'namespace' => 'Cms\\MarketingSuite'], function ($router) {
